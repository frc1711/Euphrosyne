...
public class ShooterSpeedsLookup {
    ...
    public static ShooterSpeed getShooterSpeed (double distance) {
        ...
        // Get the index of the shooter speed with distance that just barely undershoots
        int lowDistIndex = 0;
        for (int i = 0; i < allSpeeds.length; i ++) {
            
            // Found the highest speed that will just barely undershoot
        ...
        final ShooterSpeed undershoot = allSpeeds[lowDistIndex], overshoot = allSpeeds[lowDistIndex + 1];
